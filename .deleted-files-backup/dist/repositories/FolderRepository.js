...
class FolderRepository {
    ...
    async findById(id) {
        ...
        try {
            ...
            logger_1.logger.error('Error finding folder by id:', error);
            throw new Error('Failed to find folder');
        }
    }
    async findByOwnerId(ownerId, parentId) {
        ...
        try {
            ...
            logger_1.logger.error('Error finding folders by owner:', error);
            throw new Error('Failed to find folders');
        }
    }
    async findWithContents(id) {
        try {
            ...
            logger_1.logger.error('Error finding folder with contents:', error);
    ...
    `;
        try {
            ...
            logger_1.logger.error('Error updating folder:', error);
    ...
    async getFolderTree(ownerId, rootId) {
        try {
            ...
            logger_1.logger.error('Error getting folder tree:', error);
            throw new Error('Failed to get folder tree');
        }
    }
    mapDbRowToFolder(row) {
        return {
            id: row.id,
            name: row.name,
